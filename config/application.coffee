...
steroids.config.name = "CVTD bus"

# ## Start Location
steroids.config.location = "http://localhost/views/Page3/index.html"
...
# ## Navigation Bar
steroids.config.navigationBar.tintColor = "6666ff"
steroids.config.navigationBar.titleColor = "030303"
steroids.config.navigationBar.buttonTintColor = ""

steroids.config.navigationBar.buttonTintColor = "6666ff"
steroids.config.navigationBar.buttonTitleColor = "c2c2ff"
